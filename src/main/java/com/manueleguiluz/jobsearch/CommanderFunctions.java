...
public interface CommanderFunctions {
  /**
   * JCommander permite generar opciones de terminal de cualquier clase, por eso el primer parametro
   * es de tipo Object.
   *
  ...
  /**
   * Con esta funcion, facilitamos crear una configuracion inicial de JCommander, pidiendo el nombre
   * del programa y un Supplier de tipo T para los argumentos. Asi podemos usar alguna funcion que
   * nos devuelva un objeto que funcione como argumentos de JCommander.
   *
  ...
  /**
   * Funcion utilizada para tomar los datos de JCommander, los argumentos esperados y en caso de que
   * algo falle, una funcion con el JCommander que genero el error.
   */
